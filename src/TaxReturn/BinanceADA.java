...
public class BinanceADA {
    public static void main(String[] args) throws IOException, ParseException {
        File fileOut = new File("e:\\FAU_laptop_backup\\E drive\\Backup\\2019 tax return\\8949\\output\\Binance_ADA_8949.csv");
        File file = new File("e:\\FAU_laptop_backup\\E drive\\Backup\\2019 tax return\\8949\\Binance_filled_ADA_import.csv");
...
class BinanceRecord {
    ...
    public BinanceRecord() {
    }

    @Override
    public String toString() {
        return "BinanceRecord{" +
                "tranDate=" + tranDate +
                ", product='" + product + '\'' +
                ", BuySell='" + BuySell + '\'' +
                ", price=" + price +
