...
public class BinanceBCH {
    public static void main(String[] args) throws IOException, ParseException {
        File fileOut = new File("e:\\FAU_laptop_backup\\E drive\\Backup\\2019 tax return\\8949\\output\\Binance_BCH_8949.csv");
        File file = new File("e:\\FAU_laptop_backup\\E drive\\Backup\\2019 tax return\\8949\\Binance_filled_BCHABC_import.csv");
...
//            temporalStr = temporalStr.substring(0, temporalStr.length() -1 );
            Date date = new SimpleDateFormat("MM/dd/yyyy HH:mm").parse(temporalStr);

            String dateStrTmp = wordArray[0].split(" ")[0];
            Date dateTmp = new SimpleDateFormat("MM/dd/yyyy").parse(dateStrTmp);
